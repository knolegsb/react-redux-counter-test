...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    _createClass(Buttons, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { type: 'text', value: this.state.initialvalue, onChange: this.handleChange })
	            );
	        }
	    }, {
	        key: 'handleChange',
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        ...
	        onUpdateInitialValue: function onUpdateInitialValue(value) {
